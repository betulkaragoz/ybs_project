...
const ShowAllAccident = () => {
    const [data, setData] = useState([]);

    useEffect(() => {
        fetch('http://localhost/table.php') // Replace with the URL of your PHP script
            ...
            <div className='mt-5'>
                ...
                <div ref={componentRef} className='printable'>
                    <div className='ortalanmis_div mt-5'>
                        <h5>Fabrika İş Kazaları ve Ramak Kalalar</h5>
                    </div>      
                    <div className='align-items-center mt-5 ortalanmis_div mb-3'>
                        <BarChart
                            width={1000}
                            height={360}
                            data={data1}
